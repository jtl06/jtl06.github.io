...
A ring reduces the number of links by connecting stops in a loop, with cores and cache slices attached along the way. Requests travel along the ring, which mean as the ring grows, the number of hops and traffic can result in increased latency.
