...
Another approach is stacking interconnect upon interconnect. AMD's Zen processors, for example, group up to cores around a shared L3 within each CCX, and then communicate to each other via an IO Die. In this manner, communication within a cluster is faster and simple, while communication between clusters would require to jump across silicon. Minimizing the amount of cross cluster communication is important for efficiency.
